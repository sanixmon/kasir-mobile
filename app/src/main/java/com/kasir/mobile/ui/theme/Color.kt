...
//
// Identity: rental counter POS. One blue signal (action & money), amber for
...
val KasirDarkGreen = Color(0xFF3E5CFF)          // signal — primary blue
val KasirDarkGreenDark = Color(0xFF2E4ED8)      // signal-deep (pressed / container)
val KasirDarkGreenLight = Color(0xFFA7B8FF)     // signal-soft (fills)
